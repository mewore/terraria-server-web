pipeline {
    ...
    environment {
        ...
        LAUNCH_COMMAND = 'export TSW_DB_USERNAME="${TSW_DB_USERNAME}"; export TSW_DB_PASSWORD="${TSW_DB_PASSWORD}"; ' +
            'export TSW_KEYSTORE_FILENAME="' + "${env.HOME}" +
            '/${TSW_KEYSTORE_ALIAS}.jks"; export TSW_KEYSTORE_ALIAS="${TSW_KEYSTORE_ALIAS}"; export TSW_KEYSTORE_PASSWORD="${TSW_KEYSTORE_PASSWORD}"; ' +
